...
<p align="center">
  ...
  <h3 align="center">Automating Chrome Dino Game</h3>
...
This is a python app which automates the Chrome Dino Game! It is a great utility which I prefer to quickly get to high scores.
...
- Clone the repo
   ```sh
   git clone https://github.com/Aaryan-R-S/Python-Projects-Chrome-Dino-Automated.git
   ```
- Python Modules
